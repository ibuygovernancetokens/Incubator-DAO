...
/// @title Migration contract from ROOK to pROOK
/// @author IANAL
contract Migration is Ownable, Pausable {
	...
	/// @notice emitted when migrate ROOK to pROOK
	...
	//
	constructor(ERC20 _tokenROOK, ERC20 _tokenPROOK) Ownable() {
	...
	/**
	 * @notice Migrate from ROOK to pROOK
	 * @param _amount of ROOK
	 */
	function migrateROOK(uint256 _amount) external whenNotPaused {
